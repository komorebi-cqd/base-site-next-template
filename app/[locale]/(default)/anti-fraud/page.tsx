    ...
    return (
        <div>
            ...
            <div className="w-full  bg-[#161616] max-h-[var(--top-h)] h-[var(--top-h)]">
                <div className="max-w-[1440px] mx-auto h-full bg-[url('/image/anti-fraud/anti-fraud-top-bg.png')] bg-contain bg-right-bottom bg-no-repeat  px-6 xl:px-0">
                    <div className="flex flex-col text-white h-full max-w-[1200px] mx-auto pt-48 ">
                        <h3 className={`text-[58px] font-bold ${locale === "en" ? "max-w-[550px] leading-[68px]" : ""}`}>{intl.formatMessage({ id: 'ar_top_title' })}</h3>
                ...
                <div className='max-w-[1200px] mx-auto  flex flex-col items-center gap-y-7 text-sm text-[#171717]'>
                    <div className='w-full min-h-[300px] bg-white flex p-6 gap-x-12'>
                        <ul className='flex-1 leading-6'>
                            <h3 className=' text-primary text-2xl mb-4 mt-10 font-semibold'>{intl.formatMessage({ id: 'ar_ctfk_t' })}</h3>
                    ...
                    <div className={`w-full min-h-[300px] bg-white flex p-6 flex-row-reverse ${locale === "en" ? " gap-x-12" : " gap-x-12"}`}>
                        <ul className='flex-auto leading-6'>
                            <h3 className={`text-primary text-2xl mb-4 mt-10 font-semibold ${locale === "en" ? " whitespace-nowrap" : ""}`}>{intl.formatMessage({ id: 'ar_wcfk_t' })}</h3>
                        ...
                        <div className={`relative flex-shrink-0 h-[248px] ${locale === 'en' ? "w-[652px]" : "w-[692px]"}`}>
            ...
            <div className='w-full bg-white pt-16 pb-12'>
                ...
                <div className={`w-1200 flex justify-center items-center  ${locale === "en" ? "gap-5" : "gap-5"}`}>
