...
const RiskPortait = () => {
    return (
        <div>
            {/* 顶部 */}
            <PageTop bgImg='/image/risk-portrait/top-bg.png' title='风险画像' desc={desc} />
            {/* 优势 */}
            ...
            <div className=' w-full h-[48.5rem] bg-gradient-to-b  from-[#E7F1FF] to-white'>
                <div className=' max-w-[78.75rem] mx-auto h-full flex flex-col'>
                    ...
                    <div className='flex-1 flex justify-between items-center px-16'>
                        ...
                        <div>
                            <div className='text-[#316FE7] text-[2rem] font-extrabold mb-2'>我们的团队</div>
                            <div className='text-[#333333] text-base'>长期投入上百名风控专家，跟进海外风控动态，<br />挖掘新的风险，洞察新的对抗，持续的优化模型和算法；<br />专业的定制化团队，依照您的要求，制定落地方案，高效执行，快速响应。</div>
                        </div>
                    </div>
                </div>
            </div>
