                ...
                <div className={`relative z-10  h-full mx-auto w-full flex flex-col items-center justify-between text-sm pb-[1.875rem] ${locale === "en" ? "md:pt-[6.75rem]" : " pt-3 md:pt-[3.75rem]"}`}>
                    <div className='w-full flex flex-col md:flex-row gap-5 md:gap-0 md:items-start px-10 md:px-[4rem]'>
                        <div className=' relative half-item half-item1 order-5 md:order-1'>
                            ...
                            <div className={`text-[rgba(51,51,51,0.85)] leading-5 ${locale === "en" ? "w-full md:w-[278px]" : ""}`}>{intl.formatMessage({ id: 'home_half_circle_one_desc_one' })}<br />{intl.formatMessage({ id: 'home_half_circle_one_desc_two' })}</div>
                        </div>
                        ...
                        <div className=' relative half-item half-item2 order-10 md:order-10'>
                            ...
                            <div className={`text-[rgba(51,51,51,0.85)] leading-5 ${locale === "en" ? "w-full md:w-[275px]" : ""}`}>{intl.formatMessage({ id: 'home_half_circle_two_desc_one' })}<br />{intl.formatMessage({ id: 'home_half_circle_two_desc_two' })}</div>
                        </div>
                    </div>
