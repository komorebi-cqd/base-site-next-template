...
const HalfCirclePosition: React.FC<Props> = async ({ locale }) => {
    ...
    return (
        <>
            <div className='ab-c border-[60px] border-white w-halfcircleW h-halfcircleH rounded-full'></div>
            <div className='w-1200'>
                <div className=' text-center text-[38px] font-bold pt-16 pb-8'>
                    AI支付风控，为跨境出海保驾护航
                </div>
                <div className={`relative z-10  h-full mx-auto w-full flex flex-col items-center justify-between text-sm pb-[1.875rem] ${locale === "en" ? "pt-[6.75rem]" : "pt-[3.75rem]"}`}>
                    <div className='w-full flex flex-col md:flex-row gap-5 md:gap-0 md:items-start md:pl-[4rem] md:pr-[1.25rem]'>
                        ...
                        <div className=' relative mx-auto w-[412px] h-[413px] flex-shrink-0 order-1 md:order-5'>
                            <Image src="/image/home/home-ai-fk.png" fill={true} alt="" />
                        </div>
                    ...
                    <div className='w-[15rem] md:w-full flex justify-center items-center'>
