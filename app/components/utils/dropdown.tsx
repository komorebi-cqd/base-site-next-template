...
export default function Dropdown({
    ...
    return (
        ...
        >
            <a
                className={`text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out ${dropdownOpen ? 'text-gray-900' : ''}`}
                href="#0"
            ...
            <Transition
                show={dropdownOpen}
                as="ul"
                className="origin-top-right absolute top-full left-0 right-0 w-full bg-white py-2 shadow-lg"
